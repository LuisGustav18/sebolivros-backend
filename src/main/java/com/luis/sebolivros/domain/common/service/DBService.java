...
public class DBService {
    ...
    public void instaciaDB(){
        ...
        Livro livro02 = new Livro(null, "Hamlet", 2, autor02, editora02, "9788503012304", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo01);
        Livro livro03 = new Livro(null, "Dom Casmurro", 4, autor03, editora04, "9788535925697", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo01);
        Livro livro04 = new Livro(null, "1984", 5, autor04, editora03, "9788535914844", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo01);
        Livro livro05 = new Livro(null, "O Senhor dos Anéis: A Sociedade do Anel", 2, autor05, editora05, "9788533613374", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo01);
        Livro livro06 = new Livro(null, "A Hora da Estrela", 3, autor06, editora04, "9788535929770", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo03);
        Livro livro07 = new Livro(null, "A Metamorfose", 4, autor07, editora06, "9788571648496", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo04);
        Livro livro08 = new Livro(null, "Assassinato no Expresso do Oriente", 2, autor06, editora02, "9788503011345", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo05);
        Livro livro09 = new Livro(null, "Ilíada", 2, autor01, editora01, "9788563560288", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo05);
        Livro livro10 = new Livro(null, "O Hobbit", 3, autor05, editora05, "9788533613381", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo02);
        Livro livro11 = new Livro(null, "Capitães da Areia", 2, autor03, editora04, "9788535921118", Condicao.CONSERVADO, Estado.DISPONIVEL, sebo02);
